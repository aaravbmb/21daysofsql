...
/*Daily Challenge: Retrieve top 5 weeks with highest patients refusal across all services, showing week, service, patients_refused and patients_request. Sort by patients_refused in descending order.*/
